...
@Component({
  selector: 'bar-terms-and-conditions',
  template: ` <strong>Terms &amp; Conditions</strong>
    <p>
      ...
      intellectual property rights related to it, still belong to Jérôme
      Wacongne.
    </p>
    <p>
      Jérôme Wacongne is committed to ensuring that the app is as useful and
    ...
    <p>
      The Café Skifo app stores and processes personal data that you have
      ...
      features and it could mean that the Café Skifo app won’t work properly or
      at all.
    </p>
    <div>
      <p>
    ...
    <p>
      You should be aware that there are certain things that Jérôme Wacongne
      ...
      be Wi-Fi, or provided by your mobile network provider, but Jérôme Wacongne
    ...
    <p>
      Along the same lines, Jérôme Wacongne cannot always take responsibility
      ...
      avail the Service, Jérôme Wacongne cannot accept responsibility.
    </p>
    <p>
      With respect to Jérôme Wacongne’s responsibility for your use of the app,
      ...
      available to you. Jérôme Wacongne accepts no liability for any loss,
    ...
    <p>
      ...
      Jérôme Wacongne does not promise that it will always update the app so
    ...
    <p>These terms and conditions are effective as of 2020-10-27</p>
    <p><strong>Contact Us</strong></p>
    <p>
      If you have any questions or suggestions about my Terms and Conditions, do
      not hesitate to contact me at ch4mp@c4-soft.com.
    </p>
    <p>
